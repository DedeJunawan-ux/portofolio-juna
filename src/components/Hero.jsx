    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse md:flex-row items-center gap-16 md:gap-8 w-full">
        ...
        <div className="flex-1 text-center md:text-left z-20">
          ...
          <h2 className="text-xl md:text-2xl text-slate-300 font-light mb-6 font-['Space_Grotesk']">
            {t.role}
          </h2>
          
          <p className="text-slate-400 max-w-lg mx-auto md:mx-0 mb-10 leading-relaxed text-lg">
            {t.desc}
          </p>
          
          {/* Tombol Interaktif */}
          <div className="flex flex-col sm:flex-row gap-6 justify-center md:justify-start font-['Space_Grotesk']">
        ...
        {/* --- BAGIAN FOTO PROFIL --- */}
        <div className="flex-1 flex justify-center md:justify-end relative h-[400px] w-[400px] anim-float">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100%] h-[100%] bg-amber-500/10 blur-[60px] rounded-full pointer-events-none"></div>
          ...
          <div className="relative w-72 h-72 md:w-96 md:h-96 anim-morph border-4 border-cyan-400/50 p-2 shadow-[0_0_30px_rgba(6,182,212,0.3)] bg-slate-900/50 backdrop-blur-md overflow-hidden group">
            <img 
              ...
              alt="Dede Junawan Rizki" 
              className="w-full h-full object-cover object-bottom anim-morph group-hover:scale-110 group-hover:rotate-3 transition-all duration-700 ease-out"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-cyan-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 anim-morph mix-blend-overlay"></div>
          </div>
        </div>

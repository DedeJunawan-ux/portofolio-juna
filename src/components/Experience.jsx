      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          {t.jobs.map((job, index) => (
            <div key={index} className="reveal reveal-left delay-300 bg-slate-900/60 backdrop-blur-sm p-8 rounded-xl border border-slate-700/50 hover:border-cyan-400/50 transition-all duration-300 group relative overflow-hidden shadow-lg hover:shadow-[0_0_30px_rgba(6,182,212,0.15)]">
